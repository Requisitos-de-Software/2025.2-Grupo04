...
## Lista de Verificação 1.5 Histórias de Usuário

<p style="text-align: justify;">A seguir, apresenta-se a tabela com os itens utilizados na verificação do artefato <b>Histórias de Usuário</b> do aplicativo <b>ID Jovem</b>. O objetivo é garantir que as histórias estejam claras, completas e alinhadas aos princípios de requisitos ágeis definidos por (VAZQUEZ; SIMÕES, 2016) <a href="#RP1">[1]</a>.</p>

<h3 style="text-align: center;">Tabela 2: Itens do artefato Histórias de Usuário – ID Jovem</h3>
...
> VAZQUEZ, Carlos; SIMÕES, Guilherme. Engenharia de Requisitos: software orientado ao negócio. Rio de Janeiro: Brasport, 2016. Acesso em: 10 nov. 2025.
