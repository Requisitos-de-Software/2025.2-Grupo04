...
A observação é uma técnica de elicitação de requisitos que busca compreender o comportamento e as necessidades dos jovens beneficiários no contexto real de uso. Consiste em acompanhar e registrar diretamente as ações dos jovens beneficiários, seja de forma passiva, apenas observando, ou ativa, com interação controlada. O foco está em identificar padrões, problemas e oportunidades de melhoria que podem não ser verbalizados pelos participantes. Os dados coletados são analisados e organizados para definir requisitos funcionais, não funcionais ou ajustes no design do sistema. A observação é especialmente útil quando os jovens beneficiários têm dificuldade de expressar suas necessidades ou quando se deseja compreender detalhadamente o contexto de uso, fornecendo insights valiosos para soluções mais alinhadas às expectativas reais.
<br><small><em>Revisado por [Chat GPT](https://chatgpt.com/), em 22 de Novembro 2025</em></small>
## Definição da Técnica de Observação

“A observação é uma forma de coletar informações sobre como os jovens beneficiários interagem com sistemas ou processos em seu ambiente natural”<a id="anchor_1" href="#QT1">[1]</a>.
...
O objetivo da observação no nosso projeto é compreender como os jovens beneficiários interagem com o aplicativo ID Jovem<a id="anchor_3" href="#QT3">[3]</a> na prática, identificando dificuldades, comportamentos e padrões de uso que muitas vezes não são percebidos ou relatados diretamente pelos jovens beneficiários. Essa técnica permite detectar problemas na navegação, funcionalidades pouco intuitivas ou informações de difícil acesso, além de identificar oportunidades de melhoria para tornar o app mais eficiente e acessível. Com isso, a equipe consegue levantar requisitos mais precisos e propor soluções alinhadas às necessidades reais dos jovens que utilizam o sistema.<br><small><em>Revisado por [Chat GPT](https://chatgpt.com/), em 22 de Novembro 2025</em></small>
...
2.  **Coleta de dados:** registro de ações e comportamentos dos jovens beneficiários por meio de planilhas, anotações e, quando autorizado, gravações de áudio ou vídeo.
...
Além disso, a observação foi complementada por entrevistas breves, que ajudaram a esclarecer comportamentos registrados e validar hipóteses levantadas. Essa combinação enriqueceu o processo, permitindo tanto o registro das interações reais com o aplicativo ID Jovem quanto a compreensão das percepções dos jovens beneficiários.

## Resultados da Observação

A aplicação da técnica permitiu identificar dificuldades recorrentes, como problemas em localizar determinadas funcionalidades — especialmente no acesso a benefícios — e falhas na navegação, considerada pouco intuitiva por alguns jovens beneficiários. Essas questões geraram retrabalho e confusão durante o uso.
...
A técnica de observação, associada às entrevistas, contribuiu significativamente para levantar requisitos mais precisos e alinhados ao uso real do aplicativo ID Jovem. O processo permitiu identificar falhas críticas de usabilidade e oportunidades de melhoria, fornecendo à equipe subsídios concretos para propor soluções que tornem o sistema mais acessível, claro e eficiente para os jovens jovens beneficiários.
<br><small><em>Revisado por [Chat GPT](https://chatgpt.com/), em 22 de Novembro 2025</em></small>
---
