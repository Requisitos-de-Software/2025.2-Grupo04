...
2. Demandas que faltam para a entrega 5;
3. Gravações de prototipação;
4. Gravação da entrega 5;
...
| :-: | :-: | :-: | :-: | 
| Telas de prototipação de requisitos não implementados| Fazer telas no figma de requisitos não implementados no id jovem| Arthur, Breno, Dylan, Eduarda, Giovana, Leticia | 12/11 |
| Verificação de entregas | Correções das listas de verificações das entregas de 1 á 4 | Arthur, Breno, Dylan, Eduarda, Giovana, Leticia | 12/11 |
 | Validações das telas  | Gravar os videos Validando as telas com usuário | Arthur, Breno, Dylan, Eduarda, Giovana, Leticia | 12/11 |
 | Correções nas entregas | Correções de links, referencias, textos etc das outras entregas  | Arthur, Breno, Dylan, Eduarda, Giovana, Leticia | 15/11 |
| Postagem e Ata | Postar a reunião no youtube e fazer a ata no gitpage | Giovana | 12/11 | 

## 6. Observações
Na próxima reunião, será importante revisar se todas as gravações foram concluídas e estão organizadas corretamente, conferir se as entregas está completas e atualizadas, e verificar se todas as referências e alterações técnicas foram implementadas. Também sugerimos discutir o andamento da postagem e da ata no GitPages, garantindo que todos os registros do projeto estejam acessíveis e bem documentados.
<br> 
...
| :-: | :-: | :-: | :-: | :-: |
| `1.0` | 12/11/2025 | Criação da ata 12/11/2025 | [Giovana](https://github.com/GiovanaFontesS) | [Arthur](https://github.com/arthurfernandesj) |