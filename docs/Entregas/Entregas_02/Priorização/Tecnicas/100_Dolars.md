...
<https://docs.google.com/spreadsheets/d/1S2APWx_DwJRatLDyOKzvvbA2x9hz3PfT_bCf1Tbh8-o/edit?usp=sharing>
...
|--------|--------|-----------|---------|---------|---------|-------|-------|
| **RNF-01** | USA-01 | O processo de login deve ser simplificado e otimizado para minimizar o número de passos e a carga cognitiva do usuário | 5 | 3 | 1 | 5 | 14 |
| **RNF-02** | USA-02 | A interface do aplicativo deve ser intuitiva, com navegação clara, textos legíveis e design acessível | 0 | 1 | 4 | 4 | 9 |
...
| **RF-02** | AUT-01 | O sistema deve fornecer mecanismos de autenticação e login para o usuário | 2 | 2 | 6 | 2 | 12 |
| **RF-03** | EMI-01 | O sistema deve permitir a geração e emissão da carteira digital ID Jovem | 3 | 3 | 5 | 4 | 15 |
| **RF-04** | BEN-01 | O sistema deve permitir a consulta de benefícios como transporte gratuito e acesso a eventos | 3 | 3 | 4 | 4 | 14 |
| **RF-05** | VAL-01 | O sistema deve permitir a validação da carteira por estabelecimentos conveniados | 3 | 3 | 2 | 0 | 8 |
| **RF-06** | FAQ-01 | O sistema deve disponibilizar uma seção de perguntas frequentes e informações de atendimento | 3 | 1 | 2 | 2 | 8 |
| **RF-07** | SUP-01 | O sistema deve prover um canal de comunicação direto para suporte ao usuário | 0 | 5 | 1 | 4 | 10 |
...
| **RF-11** | BS-03 | O usuário deve conseguir consultar se está dentro dos critérios para ter direito ao ID Jovem | 1 | 2 | 2 | 1 | 6 |
...
| **RF-19** | BS-11 | O aplicativo deve oferecer notificações sobre vencimento e renovação | 2 | 2 | 2 | 0 | 6 |
...
| **RF-23** | INT-01 | O sistema deve permitir emissão da carteira com NIS, nome completo, data nascimento e nome da mãe | 0 | 0 | 1 | 1 | 2 |
| **RF-24** | INT-02 | O sistema deve permitir que estabelecimentos validem a autenticidade da carteira | 2 | 1 | 0 | 0 | 3 |
...
| **RNF-07** | BS-01 | O aplicativo deve ser leve e compatível com diferentes modelos de smartphones | 0 | 5 | 1 | 2 | 8 |
| **RNF-08** | BS-02 | O aplicativo deve ser intuitivo, com ícones e textos de fácil compreensão | 0 | 5 | 2 | 1 | 8 |
| **RNF-09** | BS-03 | O aplicativo deve enviar notificações sobre prazos e eventos próximos | 1 | 0 | 0 | 0 | 1 |
...
| **RNF-13** | BS-07 | O sistema deve integrar-se com o CadÚnico e serviços digitais do governo | 2 | 0 | 1 | 0 | 3 |
...
[**Aplicação da técnica de $100**](https://youtu.be/8k1RkCJvzxo?feature=shared)
...
| `1.2`  | 30/09/2025 | Atualização da tabela de Requisitos com novos dados, finzalização do documento | [Letícia Lopes](https://github.com/leticialopes20)   |    [Arthur Fernandes](https://github.com/arthurfernandesj)           |