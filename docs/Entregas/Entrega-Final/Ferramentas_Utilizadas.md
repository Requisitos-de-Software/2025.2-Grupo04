...
| :-: | :-: | :-: | :-: |
| ![Logo do GitHub](../../assets/ferramentas/github.png) | GitHub | Organização, versionamento e documentação de artefatos produzidos para o projeto. | Todas as etapas do projeto |
| ![Logo do Telegram](../../assets/ferramentas/telegram.png) | Telegram | Comunicação secundária entre o grupo e docente. | Comunicação geral |
| ![Logo do Teams](../../assets/ferramentas/teams.png) | Teams | Realização e gravação de reuniões e apresentações.| Reuniões, apresentações |
| ![Logo do Miro](../../assets/ferramentas/miro.png) | Miro | Criação de diagramas, fluxogramas e esquemas visuais. | Brainstorm, modelagem |
| ![Logo do Figma](../../assets/ferramentas/figma.png) | Figma | Produção de arte gráfica. | Prototipação, artefatos gráficos |
| ![Logo do MkDocs](../../assets/ferramentas/mkdocs.png) | MkDocs | Criação das páginas de documentação.| Todas as etapas do projeto |
| ![Logo do VSCode](../../assets/ferramentas/vscode.png) | Visual Studio Code | Edição dos arquivos de documentação.| Todas as etapas do projeto |
| ![Logo do WhatsApp](../../assets/ferramentas/whatsapp.png) | WhatsApp | Comunicação do time e avisos de demandas.| Comunicação geral |
| ![Logo do YouTube](../../assets/ferramentas/youtube.png) | YouTube | Hospedagem de vídeos produzidos.| Entregas, apresentações |
| ![Logo do Google Planilhas](../../assets/ferramentas/gsheets.png) | Google Planilhas | Criação de planilhas relacionadas ao cronograma e horários.| Priorização (FTF, In or Out, $100 Test) |
| ![Logo do Google Docs](../../assets/ferramentas/gdocs.png) | Google Docs | Primeira escrita de documentos e tabelas.| Todas as etapas do projeto |
| ![Logo do ChatGPT](../../assets/ferramentas/chatgpt.png) | ChatGPT | Ferramenta de consulta de dúvidas. | Todas as etapas |
| ![Logo do ZenHub](../../assets/ferramentas/zenhub.png) | ZenHub | Atribuição de demandas e gerenciamento do time.| Gerenciamento do projeto |
| ![Logo do This Person Not Exist](../../assets/ferramentas/thispersonnotexist.png) | This Person Not Exist | Criação de imagens falsas para personas.| Personas |
| ![Logo do Canva](../../assets/ferramentas/Canva-Logo.png) | Canva | Criação de slides para apresentações.| Apresentações |
| ![Logo do CapCut](../../assets/ferramentas/capcut.png) | CapCut | Edição de gravações das apresentações e reuniões.| Entregas, Atas, Reuniões |
