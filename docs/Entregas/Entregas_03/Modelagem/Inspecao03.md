...
| Item | Avaliação | Observação | Data | Responsável |
|------|:-:|:-:|:-:|:-:|
| **01:** Os relacionamentos entre os casos de uso (inclusão, extensão e generalização) estão claramente indicados e seguem a notação padrão UML? |  | --- | 13/10/2025 | [Giovana](https://github.com/GiovanaFontesS) |
| **02:** Os casos de uso estão bem descritos, incluindo seus fluxos principais e alternativos? |  | --- | 13/10/2025 | [Arthur](https://github.com/arthurfernandesj) |
| **03:** Os diagramas de caso de uso representam corretamente as interações entre os atores e o sistema? |  | --- | 13/10/2025 | [Breno](https://github.com/BrenoLTeixeira) |
