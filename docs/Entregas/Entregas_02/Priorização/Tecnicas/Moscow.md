...
* Usuário: Responsável por realizar a classificação dos requisitos de acordo com a técnica;
...
| Código | Origem | Descrição | Prioridade|
|--------|-----------|--------|-------|
...
| `1.4` | 24/11/2025 | adição de planilha em pdf e finalização do documento| [Letícia Lopes](https://github.com/leticialopes20) | [Arthur Fernandes](https://github.com/arthurfernandesj) |