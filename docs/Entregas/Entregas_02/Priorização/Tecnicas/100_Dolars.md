...
| Código     | Descrição                                                                                                                                   | Letícia | Arthur | Giovana | Eduarda | Noemy | TOTAL |
|------------|---------------------------------------------------------------------------------------------------------------------------------------------|---------|--------|---------|---------|-------|-------|
...
| RNF-SEG-01 | Os dados pessoais do usuário, especialmente o CPF, devem ser armazenados e transmitidos utilizando criptografia forte.                      |         |        |         |         |       |       |
...
| RF-INT-04  | O sistema deve fornecer uma seção de "Dúvidas Frequentes" sobre o programa, o CadÚnico e os benefícios.                                     |         |        |         |         |       |       |
